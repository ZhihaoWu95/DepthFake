...
\textcolor{red}{In addition, using multiple victim photos to fuse depth images of various face angles may improve face depth estimation accuracy, and increase the attack performances.}
