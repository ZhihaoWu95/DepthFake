...
\section{Discussion}
%-------------------------------------------------------------------------------
In this section, we first discuss the IR replay attack that can spoof the IR-based liveness detection which is another way of liveness detection in face authentication systems beyond using RGB and depth images. 
...
In this section, we discuss the potential countermeasures against 
\texttt{DepthFake} attacks.
