...
The results over \textcolor{red}{50} users demonstrate that \texttt{DepthFake} achieves an overall Depth attack success rate of  \textcolor{red}{$79.4\%$} and RGB-D attack success rate of  \textcolor{red}{$59.4\%$} in the real world. 
\end{abstract}